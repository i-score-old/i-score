...
# Generated by qmake (2.01a) (Qt 4.7.1) on: ven. déc. 10 11:33:37 2010
...
LIBS          = $(SUBLIBS) -F/Library/Frameworks -L/Library/Frameworks -lIscore -lDeviceManager -framework gecode -framework libxml -framework QtSvg -framework QtXml -framework QtGui -framework QtNetwork -framework QtCore 
AR            = ar cq
RANLIB        = ranlib -s
QMAKE         = /usr/bin/qmake
TAR           = tar -cf
