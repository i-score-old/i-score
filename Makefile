...
# Generated by qmake (2.01a) (Qt 4.8.3) on: Mon Dec 24 14:10:36 2012
# Project:  i-score.pro
# Template: app
...
LIBS          = $(SUBLIBS) -F/Library/Frameworks -L/Library/Frameworks /usr/local/jamoma/lib/JamomaFoundation.dylib /usr/local/jamoma/lib/JamomaScore.dylib -lDeviceManager -framework gecode -lxml2 -framework QtSvg -framework QtGui -framework QtCore -framework QtXml -framework QtNetwork 
AR            = ar cq
RANLIB        = ranlib -s
QMAKE         = /usr/bin/qmake
TAR           = tar -cf
