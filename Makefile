...
# Generated by qmake (2.01a) (Qt 4.8.1) on: Wed Sep 12 11:03:17 2012
# Project:  acousmoscribe.pro
# Template: app
# Command: /usr/bin/qmake -spec /usr/local/Qt4.8/mkspecs/macx-g++ -o Makefile acousmoscribe.pro
#############################################################################
...
SOURCES       = main.cpp \
		...
		src/GUI/BoxWidget.cpp moc/moc_Maquette.cpp \
...
Makefile: acousmoscribe.pro  /usr/local/Qt4.8/mkspecs/macx-g++/qmake.conf /usr/local/Qt4.8/mkspecs/common/unix.conf \
		/usr/local/Qt4.8/mkspecs/common/mac.conf \
		/usr/local/Qt4.8/mkspecs/common/gcc-base.conf \
		/usr/local/Qt4.8/mkspecs/common/gcc-base-macx.conf \
		/usr/local/Qt4.8/mkspecs/common/g++-base.conf \
	...
	$(QMAKE) -spec /usr/local/Qt4.8/mkspecs/macx-g++ -o Makefile acousmoscribe.pro
...
acousmoscribe.app/Contents/Info.plist: 
	...
	@sed -e "s,@SHORT_VERSION@,1.0,g" -e "s,@TYPEINFO@,????,g" -e "s,@ICON@,acousmoscribe.icns,g" -e "s,@EXECUTABLE@,acousmoscribe,g" -e "s,@TYPEINFO@,????,g" /usr/local/Qt4.8/mkspecs/macx-g++/Info.plist.app >acousmoscribe.app/Contents/Info.plist
