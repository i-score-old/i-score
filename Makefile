...
# Generated by qmake (2.01a) (Qt 4.8.3) on: Fri Dec 14 01:30:58 2012
# Project:  i-score.pro
# Template: app
# Command: /usr/bin/qmake -spec /usr/local/Qt4.8/mkspecs/macx-g++ CONFIG+=x86_64 CONFIG+=declarative_debug -o Makefile i-score.pro
#############################################################################
...
LINK          = g++
LFLAGS        = -headerpad_max_install_names -std=c++11 -stdlib=libc++ -O0 -fPIC -msse3 -L/usr/local/lib/ -L/System/Library/Frameworks/ -L/Library/Frameworks/ -arch x86_64 -Xarch_x86_64 -mmacosx-version-min=10.5
...
Makefile: i-score.pro  /usr/local/Qt4.8/mkspecs/macx-g++/qmake.conf /usr/local/Qt4.8/mkspecs/common/unix.conf \
	...
	$(QMAKE) -spec /usr/local/Qt4.8/mkspecs/macx-g++ CONFIG+=x86_64 CONFIG+=declarative_debug -o Makefile i-score.pro
