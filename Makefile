...
# Generated by qmake (2.01a) (Qt 4.8.4) on: Thu Mar 7 16:52:05 2013
# Project:  i-score.pro
# Template: app
# Command: /usr/bin/qmake -spec /usr/local/Qt4.8/mkspecs/unsupported/macx-clang -o Makefile i-score.pro
#############################################################################

####### Compiler, tools and options

CC            = clang
CXX           = /usr/bin/clang++ -std=c++11 -stdlib=libc++ -O0 -fPIC -msse3
DEFINES       = -D__Types__ -DUSE_JAMOMA_MODULAR -DQT_SVG_LIB -DQT_XML_LIB -DQT_GUI_LIB -DQT_NETWORK_LIB -DQT_CORE_LIB -DQT_SHARED
CFLAGS        = -pipe -g -gdwarf-2 -arch x86_64 -mmacosx-version-min=10.7 -Wall -W $(DEFINES)
CXXFLAGS      = -pipe -g -gdwarf-2 -arch x86_64 -mmacosx-version-min=10.7 -Wall -W $(DEFINES)
INCPATH       = -I/usr/local/Qt4.8/mkspecs/unsupported/macx-clang -I. -I/Library/Frameworks/QtCore.framework/Versions/4/Headers -I/usr/include/QtCore -I/Library/Frameworks/QtNetwork.framework/Versions/4/Headers -I/usr/include/QtNetwork -I/Library/Frameworks/QtGui.framework/Versions/4/Headers -I/usr/include/QtGui -I/Library/Frameworks/QtXml.framework/Versions/4/Headers -I/usr/include/QtXml -I/Library/Frameworks/QtSvg.framework/Versions/4/Headers -I/usr/include/QtSvg -I/usr/include -I. -Iheaders/GUI -Iheaders/data -I/Library/Frameworks -I/usr/local/jamoma/includes -I/usr/local/include/libxml2 -Imoc -F/Library/Frameworks
LINK          = clang++
LFLAGS        = -headerpad_max_install_names -std=c++11 -stdlib=libc++ -O0 -fPIC -msse3 -L/usr/local/lib/ -L/usr/local/jamoma/lib -L/System/Library/Frameworks/ -L/Library/Frameworks/ -arch x86_64
LIBS          = $(SUBLIBS) -F/Library/Frameworks -L/Library/Frameworks /usr/local/jamoma/lib/JamomaFoundation.dylib /usr/local/jamoma/lib/JamomaDSP.dylib /usr/local/jamoma/lib/JamomaScore.dylib /usr/local/jamoma/lib/JamomaModular.dylib -lDeviceManager -framework gecode -lxml2 -framework QtSvg -framework QtGui -framework QtCore -framework QtXml -framework QtNetwork 
AR            = ar cq
RANLIB        = ranlib -s
QMAKE         = /usr/bin/qmake
TAR           = tar -cf
...
Makefile: i-score.pro  /usr/local/Qt4.8/mkspecs/unsupported/macx-clang/qmake.conf /usr/local/Qt4.8/mkspecs/common/unix.conf \
		/usr/local/Qt4.8/mkspecs/common/mac.conf \
		/usr/local/Qt4.8/mkspecs/common/gcc-base.conf \
		/usr/local/Qt4.8/mkspecs/common/gcc-base-macx.conf \
		/usr/local/Qt4.8/mkspecs/common/clang.conf \
	...
	$(QMAKE) -spec /usr/local/Qt4.8/mkspecs/unsupported/macx-clang -o Makefile i-score.pro
...
i-score.app/Contents/Info.plist: 
	...
	@sed -e "s,@SHORT_VERSION@,1.0,g" -e "s,@TYPEINFO@,????,g" -e "s,@ICON@,acousmoscribe.icns,g" -e "s,@EXECUTABLE@,i-score,g" -e "s,@TYPEINFO@,????,g" /usr/local/Qt4.8/mkspecs/unsupported/macx-clang/Info.plist.app >i-score.app/Contents/Info.plist
