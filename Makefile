...
# Generated by qmake (2.01a) (Qt 4.7.0) on: jeu. oct. 14 16:11:19 2010
# Project:  mac_acousmoscribe.pro
# Template: app
# Command: /usr/bin/qmake -spec /usr/local/Qt4.7/mkspecs/macx-g++ -o Makefile mac_acousmoscribe.pro
#############################################################################
...
Makefile: mac_acousmoscribe.pro  /usr/local/Qt4.7/mkspecs/macx-g++/qmake.conf /usr/local/Qt4.7/mkspecs/common/unix.conf \
		/usr/local/Qt4.7/mkspecs/common/mac.conf \
		/usr/local/Qt4.7/mkspecs/common/mac-g++.conf \
		/usr/local/Qt4.7/mkspecs/qconfig.pri \
		/usr/local/Qt4.7/mkspecs/modules/qt_webkit_version.pri \
	...
	$(QMAKE) -spec /usr/local/Qt4.7/mkspecs/macx-g++ -o Makefile mac_acousmoscribe.pro
