...
# Generated by qmake (2.01a) (Qt 4.8.1) on: Thu Nov 29 15:06:13 2012
# Project:  i-score.pro
# Template: app
...
SOURCES       = main.cpp \
		...
		src/GUI/timeLineWidget.cpp moc/moc_Maquette.cpp \
...
moc/moc_timeLineWidget.cpp: headers/GUI/MaquetteScene.hpp \
		headers/data/Maquette.hpp \
		headers/data/Palette.hpp \
		headers/data/EnumPalette.hpp \
		headers/data/NetworkMessages.hpp \
	...
	/Developer/Tools/Qt/moc $(DEFINES) $(INCPATH) -D__APPLE__ -D__GNUC__ headers/GUI/timeLineWidget.hpp -o moc/moc_timeLineWidget.cpp
...
qrc_i-score.cpp: i-score.qrc \
		...
		images/stylesheet-branch-closed.png \
		images/help.svg \
...
timeLineWidget.o: src/GUI/timeLineWidget.cpp headers/GUI/timeLineWidget.hpp \
		headers/GUI/MaquetteScene.hpp \
		headers/data/Maquette.hpp \
		headers/data/Palette.hpp \
		headers/data/EnumPalette.hpp \
		...
		headers/data/AbstractControlBox.hpp \
		headers/data/AbstractParentBox.hpp
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o timeLineWidget.o src/GUI/timeLineWidget.cpp
...
moc_timeLineWidget.o: moc/moc_timeLineWidget.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o moc_timeLineWidget.o moc/moc_timeLineWidget.cpp
