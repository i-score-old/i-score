...
# Generated by qmake (2.01a) (Qt 4.8.3) on: ven. févr. 8 15:27:24 2013
# Project:  i-score.pro
# Template: app
...
DeviceEdit.o: src/GUI/DeviceEdit.cpp headers/GUI/DeviceEdit.hpp \
		headers/data/Maquette.hpp \
		headers/data/Palette.hpp \
		headers/data/EnumPalette.hpp \
		headers/data/NetworkMessages.hpp \
		...
		headers/GUI/CurvesWidget.hpp \
		headers/GUI/BoxWidget.hpp
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o DeviceEdit.o src/GUI/DeviceEdit.cpp
...
moc_DeviceEdit.o: moc/moc_DeviceEdit.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o moc_DeviceEdit.o moc/moc_DeviceEdit.cpp
