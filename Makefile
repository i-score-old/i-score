...
# Generated by qmake (2.01a) (Qt 4.8.4) on: Thu Mar 28 12:49:33 2013
# Project:  i-score.pro
# Template: app
...
LIBS          = $(SUBLIBS) -F/Library/Frameworks -L/Library/Frameworks -L/usr/local/jamoma/lib -lDeviceManager -lframework -lgecode -lxml2 -framework QtSvg -framework QtGui -framework QtCore -framework QtXml -framework QtNetwork 
AR            = ar cq
RANLIB        = ranlib -s
QMAKE         = /usr/bin/qmake
TAR           = tar -cf
...
MKDIR         = mkdir -p
export MACOSX_DEPLOYMENT_TARGET = 10.6.8
...
moc/moc_Maquette.cpp: headers/data/Palette.hpp \
		...
		/usr/local/jamoma/includes/TTString.h \
		/usr/local/jamoma/includes/TTThread.h \
		/usr/local/jamoma/includes/TTFifo.h \
		/usr/local/jamoma/includes/TTLimits.h \
		/usr/local/jamoma/includes/TTSymbolCache.h \
		/usr/local/jamoma/includes/TTSymbol.h \
		/usr/local/jamoma/includes/TTSymbolBase.h \
		/usr/local/jamoma/includes/TTSymbolTable.h \
		/usr/local/jamoma/includes/TTValueCache.h \
		/usr/local/jamoma/includes/TTValue.h \
		/usr/local/jamoma/includes/TTElement.h \
		/usr/local/jamoma/includes/TTAddress.h \
		/usr/local/jamoma/includes/TTAddressBase.h \
		/usr/local/jamoma/includes/TTAddressTable.h \
		/usr/local/jamoma/includes/TTAddressCache.h \
		/usr/local/jamoma/includes/TTNodeLib.h \
		/usr/local/jamoma/includes/TTHash.h \
		/usr/local/jamoma/includes/TTMutex.h \
		/usr/local/jamoma/includes/TTAddressItem.h \
		/usr/local/jamoma/includes/TTList.h \
		/usr/local/jamoma/includes/TTDataObjectBase.h \
		/usr/local/jamoma/includes/TTObjectBase.h \
		...
		/usr/local/jamoma/includes/TTInterpolate.h \
		...
		/usr/local/jamoma/includes/TTScoreSymbolCache.h \
		/usr/local/jamoma/includes/CSPTypes.hpp \
		/usr/local/jamoma/includes/TTEngine.h \
		...
		/usr/local/jamoma/includes/TTAudioObjectBase.h \
		/usr/local/jamoma/includes/TTAudioSignal.h \
		/usr/local/jamoma/includes/TTAudioSignalArray.h \
		/usr/local/jamoma/includes/TTModularSymbolCache.h \
		/usr/local/jamoma/includes/Protocol.h \
		/usr/local/jamoma/includes/Scheduler.h \
		/usr/local/jamoma/includes/TTApplication.h \
		/usr/local/jamoma/includes/TTMirror.h \
		/usr/local/jamoma/includes/TTApplicationManager.h \
		/usr/local/jamoma/includes/TTContainer.h \
		/usr/local/jamoma/includes/TTCue.h \
		/usr/local/jamoma/includes/TTCueManager.h \
		/usr/local/jamoma/includes/TTData.h \
		/usr/local/jamoma/includes/TTExplorer.h \
		/usr/local/jamoma/includes/TTInput.h \
		/usr/local/jamoma/includes/TTMapper.h \
		/usr/local/jamoma/includes/TTMapperManager.h \
		/usr/local/jamoma/includes/TTOutput.h \
		/usr/local/jamoma/includes/TTPreset.h \
		/usr/local/jamoma/includes/TTPresetManager.h \
		/usr/local/jamoma/includes/TTRamp.h \
		/usr/local/jamoma/includes/TTReceiver.h \
		/usr/local/jamoma/includes/TTSender.h \
		/usr/local/jamoma/includes/TTScript.h \
		/usr/local/jamoma/includes/TTSubscriber.h \
		/usr/local/jamoma/includes/TTTextHandler.h \
		/usr/local/jamoma/includes/TTViewer.h \
		/usr/local/jamoma/includes/TTXmlHandler.h \
...
bin/main.o: src/main.cpp headers/GUI/MainWindow.hpp \
		headers/data/Palette.hpp \
		headers/data/EnumPalette.hpp \
		headers/GUI/MaquetteScene.hpp \
		headers/data/Maquette.hpp \
...
bin/AttributeEditor.o: src/GUI/AttributeEditor.cpp headers/GUI/SoundBox.hpp \
		headers/data/EnumPalette.hpp \
		headers/data/Palette.hpp \
		headers/GUI/BasicBox.hpp \
		headers/data/AbstractBox.hpp \
		...
		headers/GUI/Interpolation.hpp \
		headers/GUI/NetworkTree.hpp
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o bin/AttributeEditor.o src/GUI/AttributeEditor.cpp
