...
# Generated by qmake (2.01a) (Qt 4.8.3) on: Thu Jan 31 18:56:39 2013
# Project:  i-score.pro
# Template: app
...
LIBS          = $(SUBLIBS) -F/Library/Frameworks -L/Library/Frameworks /usr/local/jamoma/lib/JamomaFoundation.dylib /usr/local/jamoma/lib/JamomaScore.dylib /usr/local/jamoma/lib/JamomaModular.dylib -lDeviceManager -framework gecode -lxml2 -framework QtSvg -framework QtGui -framework QtCore -framework QtXml -framework QtNetwork 
AR            = ar cq
RANLIB        = ranlib -s
QMAKE         = /usr/bin/qmake
TAR           = tar -cf
