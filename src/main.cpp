...
\li \c AlignLeft Jamoma 0.6 for Max
\li \c AlignLeft Jamoma 0.5 for Max
\li \c AlignLeft tapemovie in Max (embedded)
\li \c AlignLeft pattrstorage in Max
\li \c AlignLeft pure-data
