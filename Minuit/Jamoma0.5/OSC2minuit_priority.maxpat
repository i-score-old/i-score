{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ 516.0, 55.0, 960.0, 610.0 ],
		"bglocked" : 0,
		"defrect" : [ 516.0, 55.0, 960.0, 610.0 ],
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 324.0, 91.0, 15.0, 15.0 ]
				}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 105.0, 175.0, 106.0, 17.0 ],
									"text" : "loadmess #1"
								}
...
, 			{
				"box" : 				{
					...
					"patcher" : 					{
						"fileversion" : 1,
						"rect" : [ 344.0, 367.0, 326.0, 471.0 ],
						"bglocked" : 0,
						"defrect" : [ 344.0, 367.0, 326.0, 471.0 ],
						"openrect" : [ 0.0, 0.0, 0.0, 0.0 ],
						"openinpresentation" : 0,
						"default_fontsize" : 10.0,
						"default_fontface" : 0,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 5,
									"outlettype" : [ "", "", "", "", "" ],
									"patching_rect" : [ 65.0, 198.0, 151.0, 20.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "bang", "" ],
									"patching_rect" : [ 14.0, 203.0, 32.0, 18.0 ],
									"text" : "sel 1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 16.0, 237.0, 69.0, 18.0 ],
									"text" : "zl reg"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 14.0, 174.0, 49.0, 18.0 ],
									"text" : "zl slice 1"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 16.0, 394.0, 15.0, 15.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 16.0, 371.0, 103.0, 17.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 16.0, 344.0, 51.0, 17.0 ],
									"text" : "tosymbol"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "set", "bang" ],
									"patching_rect" : [ 130.0, 289.0, 39.0, 17.0 ],
									"text" : "t set b"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 16.0, 320.0, 192.0, 15.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 16.0, 289.0, 78.0, 17.0 ],
									"text" : "prepend append"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 16.0, 260.0, 69.0, 17.0 ],
									"text" : "route symbol"
								}
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-9", 0 ],
									"hidden" : 0,
									"midpoints" : [ 75.5, 284.0, 25.5, 284.0 ],
									"source" : [ "obj-10", 1 ]
								}
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-8", 0 ],
									"hidden" : 0,
									"midpoints" : [ 159.5, 313.0, 25.5, 313.0 ],
									"source" : [ "obj-7", 1 ]
								}
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-8", 0 ],
									"hidden" : 0,
									"midpoints" : [ 139.5, 313.0, 25.5, 313.0 ],
									"source" : [ "obj-7", 0 ]
								}
...
, 											{
												"box" : 												{
													...
													"text" : "symbol /trig_mapper.2/view/size"
												}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 5,
									"outlettype" : [ "", "", "", "", "" ],
									"patching_rect" : [ 185.0, 315.0, 136.0, 17.0 ],
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-7", 1 ],
									"hidden" : 0,
									"midpoints" : [ 282.25, 340.0, 63.5, 340.0 ],
									"source" : [ "obj-8", 3 ]
								}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 371.0, 529.0, 116.0, 17.0 ],
					"text" : "prepend #1:get"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 212.0, 529.0, 150.0, 17.0 ],
					"text" : "prepend #1!namespace"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 29.0, 531.0, 150.0, 17.0 ],
					"text" : "prepend #1:namespace"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "route #2?namespace #2?get #2:namespace #2!set"
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-17", 0 ],
					"hidden" : 0,
					"midpoints" : [ 186.25, 117.0, 385.5, 117.0 ],
					"source" : [ "obj-34", 1 ]
				}
