...
public:
	...
	void addWaitedTriggerPointMessageAction(void(*pt2Func)(bool, unsigned int, unsigned int, unsigned int, std::string));
	...
	unsigned int addAntPostRelation(unsigned int boxId1, unsigned int controlPoint1, unsigned int boxId2, unsigned int controlPoint2, TemporalRelationType type, std::vector<unsigned int>* movedBoxes = NULL);
	...
	unsigned int addTemporalRelation(unsigned int boxId1, unsigned int controlPoint1, unsigned int boxId2,
			...
			std::vector<unsigned int>* movedBoxes = NULL);
	unsigned int addAntPostRelation(unsigned int boxId1, unsigned int controlPoint1, unsigned int boxId2, unsigned int controlPoint2, TemporalRelationType type, int minBound, int maxBound, std::vector<unsigned int>* movedBoxes = NULL);
	...
	void changeAntPostRelationBounds(unsigned int relationId, int minBound, int maxBound, std::vector<unsigned int>* movedBoxes = NULL);
	...
	bool performMoving(unsigned int boxId, int x, int y, int maxSceneWidth, std::vector<unsigned int>* movedBoxes, unsigned int maxModification = NO_MAX_MODIFICATION);
	...
	int getDuration(unsigned int boxId);
	...
	void setControlPointMessagesToSend(unsigned int boxId, unsigned int controlPointIndex, std::vector<std::string> messageToSend, bool muteState = false);
	...
	void getControlPointMessagesToSend(unsigned int boxId, unsigned int controlPointIndex, std::vector<std::string>* messages);
	...
	void setControlPointMuteState(unsigned int boxId, unsigned int controlPointIndex, bool mute);
	...
	bool getControlPointMuteState(unsigned int boxId, unsigned int controlPointIndex);
	...
	void setBoxContentMuteState(unsigned int boxId, bool mute);
	...
	void setBoxMuteState(unsigned int boxId, bool mute);
	...
	void curvesAddCurves(unsigned int boxId, std::string address);
	...
	void curvesRemoveCurves(unsigned int boxId, std::string address);
	...
	void curvesRemoveAllCurves(unsigned int boxId);
	...
	std::vector<std::string> curvesGetAllCurvesAddress(unsigned int boxId);
	...
	void curvesSetSampleRate(unsigned int boxId, std::string address, unsigned int nbSamplesBySec);
	...
	unsigned int curvesGetSampleRate(unsigned int boxId, std::string address);
	...
	void curvesSetAvoidRedundancyInformation(unsigned int boxId, std::string address, bool avoidRedundancy);
	...
	bool curvesGetAvoidRedundancyInformation(unsigned int boxId, std::string address);
	...
	void curvesGetArgsTypes(std::string stringToParse, std::vector<std::string>* result);
	...
	bool curvesSetSections(unsigned int boxId, std::string address, unsigned int argNb,
			std::vector<float> xPercents, std::vector<float> yValues, std::vector<short> sectionType, std::vector<float> coeff);
	...
	bool curvesGetCurve(unsigned int boxId, std::string address, unsigned int argNb, std::vector<float>* result);
	...
	void getAllBoxesId(std::vector<unsigned int>* boxesID);
	...
	void getAllRelationsId(std::vector<unsigned int>* relationsID);
	...
	void getAllTriggersId(std::vector<unsigned int>* triggersID);
	...
	unsigned int getExecutionTimeInMs();
	...
	unsigned int getProcessProgressionPercent(unsigned int processId);
	...
	void simulateNetworkMessageReceptionForTriggerPoint(std::string netMessage);
	...
	void networkGetAllLoadedPlugins(std::vector<std::string>* pluginsName, std::vector<unsigned int>* listeningPort);
	...
	void networkAddDevices(std::string deviceName, std::string pluginToUse, std::string deviceIp, std::string devicePort);
	...
	void networkRemoveDevices(std::string deviceName);
	...
	void networkSendMessage(std::string stringToSend);
	...
	void networkGetAllDevicesName(std::vector<std::string>* devicesName, std::vector<bool>* couldSendNamespaceRequest);
	...
	std::vector<std::string> networkSnapShot(std::string address);
	...
	int networkNamespace(std::string address, std::vector<std::string>* nodes, std::vector<std::string>* leaves, std::vector<std::string>* attributs, std::vector<std::string>* attributsValue);
